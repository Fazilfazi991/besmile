export const permissionCatalogue = [
  'admin.access','admin.shell','employees.view','employees.manage','employees.create','employees.edit','organization_chart.manage','employees.status.manage','attendance.view_self','attendance.view_team','attendance.manage',
...
export const superAdminNavigation = [
  ...
  { title: 'COMMUNICATION', links: [{ label: 'Teams', href: '/admin/chat', permission: 'chat.use' }, { label: 'Announcements', href: '/admin/announcements', permission: 'announcements.manage' }, { label: 'Notifications', href: '/admin/notifications', permission: 'notifications.view' }] },
