export const permissionCatalogue = [
  'admin.access','admin.shell','employees.view','employees.manage','employees.create','employees.edit','employees.status.manage','attendance.view_self','attendance.view_team','attendance.manage','work_performance.view',
