...
describe('meeting edit form state', () => {
  ...
  it('prepopulates all editable meeting metadata in BSmile time', () => expect(meetingFieldsFromRecord(meeting)).toMatchObject({ hostId: 'host-1', title: 'Weekly planning', agenda: 'Review priorities', date: '2026-08-11', start: '15:00', end: '16:00', type: 'google_meet', venue: 'Room 4', url: 'https://meet.google.com/example', notes: 'Bring the roadmap' }));
