...
describe('meeting edit form state', () => {
  ...
  it('allows the assigned host to edit their meeting', () => expect(canEditMeeting({ 'meetings.view': true }, meeting, 'host-1')).toBe(true));
  it('prepopulates host and all editable metadata in BSmile time', () => expect(meetingFieldsFromRecord(meeting)).toMatchObject({ title: 'Weekly planning', agenda: 'Review priorities', hostId: 'host-1', date: '2026-08-11', start: '15:00', end: '16:00', type: 'google_meet', venue: 'Room 4', url: 'https://meet.google.com/example', notes: 'Bring the roadmap' }));
