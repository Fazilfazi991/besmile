...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'WORK MANAGEMENT', links: [{ label: 'Tasks', href: '/admin/tasks', requirement: anyOf('tasks.assign') }, { label: 'Task Access', href: '/admin/task-access', requirement: anyOf('tasks.manage_access') }, { label: 'My Calendar', href: '/admin/calendar', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Holiday Calendar', href: '/admin/holidays', requirement: anyOf('holiday_calendar.manage') }, { label: 'Meetings', href: '/admin/meetings', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Innovation Hub', href: '/admin/ideas', requirement: anyOf('ideas.view', 'ideas.manage_status', 'ideas.view_reports') }, { label: 'Innovation Categories', href: '/admin/ideas/categories', requirement: anyOf('ideas.manage_categories') }] },
