...
export function adminRouteRequirement(path: string): PermissionRequirement {
  ...
  if (path.startsWith('/admin/innovation')) return anyOf('innovation.view_all', 'innovation.review', 'innovation.manage', 'innovation.create', 'innovation.view_self');
  if (path.startsWith('/admin/ideas/categories')) return anyOf('ideas.manage_categories');
  if (path.startsWith('/admin/ideas')) return anyOf('innovation.view_all', 'innovation.review', 'innovation.manage', 'innovation.create', 'innovation.view_self');
...
export function employeeRouteRequirement(path: string): PermissionRequirement | undefined {
  ...
  if (path.startsWith('/employee/innovation') || path.startsWith('/employee/ideas')) return anyOf('innovation.view_self', 'innovation.create', 'ideas.view');
...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'INNOVATION & DEVELOPMENT', links: [{ label: 'Innovation Hub', href: '/admin/innovation', activeHrefs: ['/admin/ideas'], requirement: anyOf('innovation.view_all', 'innovation.review', 'innovation.manage', 'innovation.create', 'innovation.view_self') }] },
