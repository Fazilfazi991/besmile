...
export function sectionNavigation(groups: readonly NavigationGroup[]): NavigationSection[] {
  const sections: NavigationSection[] = [
    ...
    { title: 'Work Management', links: [] }, { title: 'CRM', links: [] },
...
export const employeeNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'COMMUNICATION', links: [{ label: 'Notifications', href: '/employee/notifications' }, { label: 'Teams', href: '/employee/chat', requirement: anyOf('chat.use') }, { label: 'Profile', href: '/employee/profile' }] },
