...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'WORK MANAGEMENT', links: [{ label: 'Tasks', href: '/admin/tasks', requirement: anyOf('tasks.manage', 'tasks.assign') }, { label: 'Task Access', href: '/admin/task-access', requirement: anyOf('tasks.manage_access') }, { label: 'My Calendar', href: '/admin/calendar', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Meetings', href: '/admin/meetings', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Innovation Hub', href: '/admin/ideas', requirement: anyOf('ideas.view', 'ideas.manage_status', 'ideas.view_reports') }, { label: 'Innovation Categories', href: '/admin/ideas/categories', requirement: anyOf('ideas.manage_categories') }] },
...
export const employeeNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'MY WORK', links: [{ label: 'My Tasks', href: '/employee/tasks', requirement: anyOf('tasks.view_self', 'tasks.assign') }, { label: 'Manage Tasks', href: '/employee/tasks/manage', requirement: anyOf('tasks.assign') }, { label: 'My Calendar', href: '/employee/calendar' }, { label: 'Meetings', href: '/employee/meetings' }, { label: 'Innovation Hub', href: '/employee/ideas', activeHrefs: ['/admin/ideas'], requirement: anyOf('ideas.view') }] },
