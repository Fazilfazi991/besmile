...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'HR & EMPLOYEE MANAGEMENT', links: [{ label: 'Employees', href: '/admin/employees', requirement: anyOf('employees.view') }, { label: 'My Attendance', href: '/admin/my-attendance', requirement: anyOf('attendance.self') }, { label: 'Staff Attendance', href: '/admin/attendance', requirement: anyOf('attendance.view', 'attendance.manage') }, { label: 'Leave Approvals', href: '/admin/leaves', requirement: anyOf('leave.approve', 'leave.manage', 'leave.review') }, { label: 'My Profile', href: '/admin/profile', requirement: anyOf('admin.access', 'dashboard.view') }] },
