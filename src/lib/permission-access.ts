...
export function adminRouteRequirement(path: string): PermissionRequirement {
  ...
  if (path.startsWith('/admin/work-performance')) return anyOf('work_performance.view');
