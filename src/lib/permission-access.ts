...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'WORK MANAGEMENT', links: [{ label: 'Leave approvals', href: '/admin/leaves', requirement: anyOf('leave.approve', 'leave.manage', 'leave.review') }, { label: 'Tasks', href: '/admin/tasks', requirement: anyOf('tasks.manage', 'tasks.assign') }, { label: 'Task Access', href: '/admin/task-access', requirement: anyOf('tasks.manage_access') }, { label: 'Idea Hub', href: '/admin/ideas', requirement: anyOf('ideas.view', 'ideas.manage_status', 'ideas.view_reports') }, { label: 'Idea Categories', href: '/admin/ideas/categories', requirement: anyOf('ideas.manage_categories') }] },
