...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'FINANCE', links: [{ label: 'Business Status', href: '/admin/business-status', requirement: anyOf('business_status.view') }, { label: 'Finance Dashboard', href: '/admin/finance', requirement: anyOf('finance.dashboard.view', 'finance.view') }, { label: 'Income', href: '/admin/finance/income', requirement: anyOf('income.view', 'income.manage') }, { label: 'Expenses', href: '/admin/finance/expenses', requirement: anyOf('expenses.view', 'expenses.manage') }, { label: 'Invoices', href: '/admin/finance/invoices', requirement: anyOf('invoices.view', 'invoices.manage') }, { label: 'Payroll', href: '/admin/finance/payroll', requirement: anyOf('payroll.view', 'payroll.manage') }, { label: 'Psychologist Payments', href: '/admin/finance/psychologist-payments', requirement: anyOf('psychologist_payments.view') }, { label: 'Reports', href: '/admin/finance/reports', requirement: anyOf('reports.finance.view', 'reports.view') }] },
