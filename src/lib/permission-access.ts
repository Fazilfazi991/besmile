...
export function adminRouteRequirement(path: string): PermissionRequirement {
  ...
  if (path.startsWith('/admin/business-status')) return anyOf('business_status.view');
...
export const adminNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'OPERATIONS', links: [{ label: 'Employees', href: '/admin/employees', requirement: anyOf('employees.view') }, { label: 'Official Documents', href: '/admin/documents/generate', requirement: anyOf('documents.manage', 'documents.employee.manage') }, { label: 'Operational Documents', href: '/admin/documents', exact: true, requirement: anyOf('documents.manage', 'documents.employee.manage', 'documents.administration.manage') }] },
  { title: 'WORK MANAGEMENT', links: [{ label: 'My Attendance', href: '/admin/my-attendance', requirement: anyOf('attendance.self') }, { label: 'Staff Attendance', href: '/admin/attendance', requirement: anyOf('attendance.view', 'attendance.manage') }, { label: 'My Calendar', href: '/admin/calendar', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Meetings', href: '/admin/meetings', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Leave approvals', href: '/admin/leaves', requirement: anyOf('leave.approve', 'leave.manage', 'leave.review') }, { label: 'Tasks', href: '/admin/tasks', requirement: anyOf('tasks.manage', 'tasks.assign') }, { label: 'Task Access', href: '/admin/task-access', requirement: anyOf('tasks.manage_access') }, { label: 'Innovation Hub', href: '/admin/ideas', requirement: anyOf('ideas.view', 'ideas.manage_status', 'ideas.view_reports') }, { label: 'Innovation Categories', href: '/admin/ideas/categories', requirement: anyOf('ideas.manage_categories') }] },
  { title: 'COMMUNICATION', links: [{ label: 'Chat', href: '/admin/chat', requirement: anyOf('chat.use') }, { label: 'Policy Assistant', href: '/admin/policy-assistant', exact: true, requirement: anyOf('policy_assistant.use') }, { label: 'Manage Policies', href: '/admin/policy-assistant/manage', requirement: anyOf('policy_assistant.manage') }, { label: 'Announcements', href: '/admin/announcements', requirement: anyOf('announcements.manage') }, { label: 'Notifications', href: '/admin/notifications', requirement: anyOf('notifications.view') }, { label: 'Profile', href: '/admin/profile', requirement: anyOf('admin.access', 'dashboard.view') }] },
  { title: 'CLIENT & CRM', links: [{ label: 'CRM Overview', href: '/admin/crm', requirement: anyOf('crm.manage_all', 'crm.view_team', 'leads.view') }, { label: 'Clients', href: '/admin/patients', requirement: anyOf('patients.view', 'patients.view_assigned', 'patients.view_all') }, { label: 'Leads', href: '/admin/crm/leads', requirement: anyOf('crm.manage_all', 'crm.view_team', 'leads.view') }, { label: 'Follow-ups', href: '/admin/crm/follow-ups', requirement: anyOf('crm.manage_all', 'crm.view_team', 'leads.view') }, { label: 'Appointment & Scheduling', href: '/admin/doctor-scheduling', requirement: anyOf('doctor_scheduling.view') }, { label: 'Customer Feedback', href: '/admin/customer-feedback', requirement: anyOf('customer_feedback.view') }, { label: 'Import Leads', href: '/admin/crm/import', requirement: anyOf('crm.import') }, { label: 'Sales', href: '/admin/crm/sales', requirement: anyOf('crm.manage_all', 'crm.view_team', 'sales.view') }] },
  { title: 'FINANCE', links: [{ label: 'Accounts & Business Status', href: '/admin/business-status', requirement: anyOf('business_status.view') }, { label: 'Finance Dashboard', href: '/admin/finance', requirement: anyOf('finance.dashboard.view', 'finance.view') }, { label: 'Income', href: '/admin/finance/income', requirement: anyOf('income.view', 'income.manage') }, { label: 'Expenses', href: '/admin/finance/expenses', requirement: anyOf('expenses.view', 'expenses.manage') }, { label: 'Invoices', href: '/admin/finance/invoices', requirement: anyOf('invoices.view', 'invoices.manage') }, { label: 'Payroll', href: '/admin/finance/payroll', requirement: anyOf('payroll.view', 'payroll.manage') }, { label: 'Psychologist Payments', href: '/admin/finance/psychologist-payments', requirement: anyOf('psychologist_payments.view') }, { label: 'Reports', href: '/admin/finance/reports', requirement: anyOf('reports.finance.view', 'reports.view') }] },
...
export const employeeNavigation: readonly NavigationGroup[] = [
  ...
  { title: 'WORKSPACE', links: [{ label: 'Dashboard', href: '/employee/dashboard', requirement: anyOf('dashboard.view') }, { label: 'Attendance', href: '/employee/attendance', requirement: anyOf('attendance.self', 'attendance.view_self', 'attendance.view', 'attendance.manage') }, { label: 'My Calendar', href: '/employee/calendar' }, { label: 'Meetings', href: '/employee/meetings', requirement: anyOf('meetings.view', 'meetings.create', 'meetings.manage') }, { label: 'Leave', href: '/employee/leaves', requirement: anyOf('leave.self', 'leave.request', 'leave.view', 'leave.manage', 'leave.approve') }, { label: 'Tasks', href: '/employee/tasks', requirement: anyOf('tasks.view_self', 'tasks.assign') }, { label: 'Manage Tasks', href: '/employee/tasks/manage', requirement: anyOf('tasks.assign') }, { label: 'Innovation Hub', href: '/employee/ideas', activeHrefs: ['/admin/ideas'], requirement: anyOf('ideas.view') }, { label: 'Documents', href: '/employee/documents', requirement: anyOf('documents.view', 'documents.employee.view', 'patient_documents.view') }] },
  { title: 'OPERATIONS', links: [{ label: 'Employees', href: '/admin/employees', requirement: requireAllAndAny(['admin.shell'], ['employees.view']) }, { label: 'Operational Documents', href: '/admin/documents', requirement: requireAllAndAny(['admin.shell'], ['documents.employee.manage', 'documents.administration.manage']) }] },
  { title: 'COMMUNICATION', links: [{ label: 'Notifications', href: '/employee/notifications' }, { label: 'Chat', href: '/employee/chat', requirement: anyOf('chat.use') }, { label: 'Policy Assistant', href: '/employee/policy-assistant', requirement: anyOf('policy_assistant.use') }, { label: 'Profile', href: '/employee/profile' }] },
  { title: 'CLIENT & CRM', links: [{ label: 'CRM Overview', href: '/admin/crm', requirement: requireAllAndAny(['admin.shell'], ['crm.manage_all', 'crm.view_team', 'leads.view', 'sales.view']) }, { label: 'Clients', href: '/admin/patients', requirement: requireAllAndAny(['admin.shell'], ['patients.view', 'patients.view_all']) }, { label: 'Leads', href: '/admin/crm/leads', requirement: requireAllAndAny(['admin.shell'], ['crm.manage_all', 'crm.view_team', 'leads.view']) }, { label: 'Follow-ups', href: '/admin/crm/follow-ups', requirement: requireAllAndAny(['admin.shell'], ['crm.manage_all', 'crm.view_team', 'leads.view']) }, { label: 'Appointment & Scheduling', href: '/admin/doctor-scheduling', requirement: requireAllAndAny(['admin.shell'], ['doctor_scheduling.view']) }, { label: 'CRM Overview', href: '/employee/crm', requirement: requireAnyWithout(['crm.view_assigned', 'crm.view_team', 'crm.manage_all', 'leads.view', 'sales.view'], ['admin.shell']) }, { label: 'Clients', href: '/employee/patients', requirement: requireAnyWithout(['patients.view'], ['admin.shell']) }, { label: 'Assigned Clients', href: '/employee/assigned-patients', activeHrefs: ['/employee/patients'], requirement: requireAnyWithout(['patients.view_assigned'], ['admin.shell']) }, { label: 'Leads', href: '/employee/crm/leads', requirement: requireAnyWithout(['crm.view_assigned', 'crm.view_team', 'crm.manage_all', 'leads.view'], ['admin.shell']) }, { label: 'Follow-ups', href: '/employee/crm/follow-ups', requirement: requireAnyWithout(['crm.view_assigned', 'crm.view_team', 'crm.manage_all', 'leads.view'], ['admin.shell']) }, { label: 'Appointment & Scheduling', href: '/employee/doctor-scheduling', activeHrefs: ['/admin/doctor-scheduling'], requirement: requireAnyWithout(['doctor_scheduling.view'], ['admin.shell']) }, { label: 'Sales', href: '/employee/crm/sales', requirement: requireAnyWithout(['crm.view_team', 'crm.manage_all', 'sales.view'], ['admin.shell']) }] },
];
