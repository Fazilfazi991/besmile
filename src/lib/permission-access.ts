...
export type NavigationLink = { label: string; href: string; requirement?: PermissionRequirement; activeHrefs?: readonly string[] };
...
export const employeeNavigation: readonly NavigationGroup[] = [
  { title: 'WORKSPACE', links: [{ label: 'Dashboard', href: '/employee/dashboard', requirement: anyOf('dashboard.view') }, { label: 'Attendance', href: '/employee/attendance', requirement: anyOf('attendance.self', 'attendance.view_self', 'attendance.view', 'attendance.manage') }, { label: 'Leave', href: '/employee/leaves', requirement: anyOf('leave.self', 'leave.request', 'leave.view', 'leave.manage', 'leave.approve') }, { label: 'Tasks', href: '/employee/tasks', requirement: anyOf('tasks.view_self', 'tasks.assign') }, { label: 'Manage Tasks', href: '/employee/tasks/manage', requirement: anyOf('tasks.assign') }, { label: 'Doctor Scheduling', href: '/employee/doctor-scheduling', activeHrefs: ['/admin/doctor-scheduling'], requirement: anyOf('doctor_scheduling.view') }, { label: 'Innovation Hub', href: '/employee/ideas', activeHrefs: ['/admin/ideas'], requirement: anyOf('ideas.view') }, { label: 'Patients', href: '/employee/patients', activeHrefs: ['/admin/patients'], requirement: anyOf('patients.view') }, { label: 'Assigned Patients', href: '/employee/assigned-patients', activeHrefs: ['/employee/patients'], requirement: anyOf('patients.view_assigned') }, { label: 'Documents', href: '/employee/documents', requirement: anyOf('documents.view', 'documents.employee.view', 'patient_documents.view') }] },
