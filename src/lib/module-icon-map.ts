...
export const SEMANTIC_ICON_NAMES = {
  ...
  'Communication': 'MessageCircleMore', 'Performance': 'Gauge', 'CRM': 'Target', 'Finance': 'WalletCards',
  ...
  'Leads': 'UserRoundSearch', 'My Leads': 'UserRoundSearch', 'Leads Management': 'UserRoundSearch', 'Follow-ups': 'PhoneCall',
  ...
  'Leave requests': 'CalendarCheck', 'Leave approvals': 'CalendarCheck', 'Feedback': 'MessageSquareHeart',
