...
import { dateKey, minutes } from '@/lib/attendance-rules';
...
const duration = (row: any) => row?.clock_in ? `${Math.floor(minutes(row) / 60)}h ${minutes(row) % 60}m` : '—';
