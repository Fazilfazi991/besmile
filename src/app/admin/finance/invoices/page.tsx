...
export default function Invoices() {
  ...
  const shown = useMemo(() => items.filter(invoice => {
    ...
    const effectiveStatus = effectiveInvoiceStatus(invoice, today);
