...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Middleware has already checked admin.access before this layout renders. Keep
  // the dashboard reachable if an individual SSR RPC lookup is unavailable.
  allowed.add('admin.access');
