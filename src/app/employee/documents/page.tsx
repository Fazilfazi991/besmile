...
export default function DocumentsPage() {
  ...
  const upload = async (requestId: string, file: File) => { try { await employeeRepository.submitRequestedDocument(profile.id, requestId, file); setNotice('Document submitted for review.'); await load(); } catch (caught: any) { setError(caught.message || 'Unable to upload document.'); } };
