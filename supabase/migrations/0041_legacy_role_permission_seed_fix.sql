...
begin
  if exists (
    ...
    from (values
      ...
      ('Social Worker', array['dashboard.view','leads.view','leads.create','leads.edit','leads.manage_status','employees.view','innovation.view','innovation.create','innovation.comment','calendar.view','calendar.create','calendar.edit','feedback.view','members.view','patients.view','patients.create','patients.edit','patient_documents.view','patient_documents.upload','patient_documents.download','patient_notes.view','patient_notes.create','patient_notes.edit']::text[]),
    ...
    join public.permissions permission on
      ...
      or (role.code='social_worker' and permission.code=any(array['dashboard.view','leads.view','leads.create','leads.edit','leads.manage_status','employees.view','innovation.view','innovation.create','innovation.comment','calendar.view','calendar.create','calendar.edit','feedback.view','members.view','patients.view','patients.create','patients.edit','patient_documents.view','patient_documents.upload','patient_documents.download','patient_notes.view','patient_notes.create','patient_notes.edit']))
