...
-- Recovered from supabase/migrations/20260814054449_psychologist_payment_statements.sql
...
revoke execute on function public.prepare_psychologist_payment_statement(uuid[],uuid),public.finalize_psychologist_payment_statement(uuid,text,text,bigint,integer),public.discard_prepared_psychologist_payment_statement(uuid),public.record_psychologist_payment_statement_download(uuid) from public,anon;
