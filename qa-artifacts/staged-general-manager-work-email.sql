...
begin
  ...
  where employee_code = 'A001'
    and full_name = 'Muhammad Faiz AU'
    and role::text = 'general_manager';
  if matching_profiles <> 1 then
    raise exception 'General Manager profile guard failed: expected one A001 / Muhammad Faiz AU / general_manager, found %', matching_profiles;
  end if;
end $$;
